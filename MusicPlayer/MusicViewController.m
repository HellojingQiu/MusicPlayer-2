...
//        NSLog(@"%d",isPlay);
//        NSLog(@"%d",isCircle);
//        NSLog(@"%lu",timeArray.count);
//        NSLog(@"%lu",LRCDictionary.count);
//        NSLog(@"%lu",musicArray.count);
//        NSLog(@"%0.4f",progressSlider.value);
//        NSLog(@"%lu",lrcLineNumber);
//        NSLog(@"%lu",musicArrayNumber);
    }
}
#pragma mark 摇一摇 换歌
...
//    [timeArray count]?[[[[timeArray objectAtIndex:section] objectForKey:@"subs"] objectAtIndex:0] objectForKey:@"section"]:@"";
//    
//    [timeArray count]?[[[timeArray objectAtIndex:section] objectForKey:@"subs"] count]:0;
    
    if (tableView.tag == 1) {
        NSLog(@"numberMusicArray:%lu",[musicArray count]);
        return [musicArray count];
    } else {
        if (flag) {
            NSLog(@"numberTimeArray:%lu",[timeArray count]);
        }
